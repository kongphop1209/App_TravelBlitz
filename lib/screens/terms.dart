  ...
  void _scrollListener() {
    setState(() {
      _isScrolled = _scrollController.hasClients &&
          _scrollController.offset > (kToolbarHeight * 0.5);
    });
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '3.1. Booking and Reservations: TravelBlitz may provide features for booking flights or making reservations with airlines. Users are solely responsible for reviewing and adhering to the terms and conditions set forth by airlines.',
                  style: TextStyle(fontSize: 12.sp),
                ),
                SizedBox(height: 5.h),
                Text(
